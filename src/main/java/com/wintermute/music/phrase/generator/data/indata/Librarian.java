...
import com.wintermute.music.generator.grammar.ParaStack;
import com.wintermute.music.generator.grammar.WordStack;
...
public class Librarian {
    ...
    private WordStack commonWords = null;
    private File CommonWordsFile = null;
    HashSet<String> commonWordsHash = null;
    ...
    private Librarian() {
        ...
        commonWords = new WordStack( WordStack.WorkStackType.Common, f);
        commonWordsHash = new HashSet<>();
        for( String w : commonWords ) {
            commonWordsHash.add(w);
        }
    ...
    public boolean isCommonWord( String test ) {
        return this.commonWordsHash.contains(test);
    }
    ...
    public WordStack getCommonWords() {
        WordStack commonWords1 = this.commonWords;
        return commonWords1;
    }
